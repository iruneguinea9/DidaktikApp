...
public class ExplicacionAct6 extends AppCompatActivity {
    Button goazen;
    Switch volumen;
    TextView texto;
    ImageView imagen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_explicacion_act6);
        ...
        // Iniciamos el Audio
        mediaPlayer = MediaPlayer.create(this, R.raw.explicacion_act6);
        mediaPlayer.start();
        ...
        texto.startAnimation(AnimationUtils.loadAnimation(ExplicacionAct6.this, R.anim.animaciontexto));
        ...
        goazen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ExplicacionAct6.this, Actividad6.class);
    ...
    public String leer(){
        String texto ="";
        try {
            InputStream fraw = getResources().openRawResource(R.raw.explicacion6);
