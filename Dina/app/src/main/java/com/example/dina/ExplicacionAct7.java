...
public class ExplicacionAct7 extends AppCompatActivity {
    Button goazen;
    Switch volumen;
    TextView texto;
    ImageView imagen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_explicacion_act7);
        ...
        // Iniciamos el Audio
        mediaPlayer = MediaPlayer.create(this, R.raw.explicacion_act7);
        mediaPlayer.start();
        ...
        texto.startAnimation(AnimationUtils.loadAnimation(ExplicacionAct7.this, R.anim.animaciontexto));
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                imagen.setImageDrawable(getDrawable(R.drawable.gune7_2));
        ...
        goazen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ExplicacionAct7.this, Actividad7.class);
    ...
    public String leer(){
        String texto ="";
        try {
            InputStream fraw = getResources().openRawResource(R.raw.explicacion7);
